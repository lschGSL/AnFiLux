...
def generate_pdf(analysis_text, ratios_dict):
    """
    Génère un PDF contenant le texte d'analyse et un tableau des ratios.
    """
    buffer = io.BytesIO()
...
if uploaded_file is not None:
    ...
    try:
        if file_extension in [".xlsx", ".xls"]:
            ...
            # Pour le PDF, on tente d'extraire les tableaux avec tabula-py (attention à l'installation et la configuration de Java)
            try:
                import tabula

...
# Utiliser le répertoire temporaire de l'environnement
temp_dir = tempfile.gettempdir()
file_path = os.path.join(temp_dir, "luxembourg_financial_analysis_test.py")
...
st.write(f"Le fichier a été écrit dans : {file_path}")
